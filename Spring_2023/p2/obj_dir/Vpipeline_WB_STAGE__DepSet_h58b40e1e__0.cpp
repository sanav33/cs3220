                                            ...
                                            | (QData)((IData)(
                                                              ((vlSymsp->TOP__pipeline.__PVT__my_MEM_stage__DOT__MEM_latch[5U] 
                                                               ...
                                                               | (vlSymsp->TOP__pipeline.__PVT__my_MEM_stage__DOT__MEM_latch[4U] 
                                                                  >> 0xcU))))) 
                                           >> 0x20U));
        vlSelf->WB_counters[4U] = (1U & vlSymsp->TOP__pipeline.__PVT__my_MEM_stage__DOT__MEM_latch[1U]);
                                     ...
                                     << 0x25U) | (((QData)((IData)(
                                                                   (0x1fU 
                                                                    & (vlSymsp->TOP__pipeline.__PVT__my_MEM_stage__DOT__MEM_latch[1U] 
                                                                       >> 1U)))) 
                                                   << 0x20U) 
                                                  | (QData)((IData)(vlSelf->__PVT__regval_WB))));
}
...
VL_INLINE_OPT void Vpipeline_WB_STAGE___nba_sequent__TOP__pipeline__my_WB_stage__2(Vpipeline_WB_STAGE* vlSelf) {
    ...
    } else if ((1U & vlSymsp->TOP__pipeline.__PVT__my_MEM_stage__DOT__MEM_latch[1U])) {
        VL_ASSIGNSEL_WI(1024,32,(0x3e0U & (vlSymsp->TOP__pipeline.__PVT__my_MEM_stage__DOT__MEM_latch[1U] 
                                           << 4U)), vlSelf->last_WB_value, vlSelf->__PVT__regval_WB);
    }
}
